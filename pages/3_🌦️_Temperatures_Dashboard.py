...
min_temp_city = min_temp_df['City'].values[0]
min_temp_date = min_temp_df['Date'].values[0]

max_temp_city = max_temp_df['City'].values[0]
max_temp_date = max_temp_df['Date'].values[0]
